...
class CodeRetrieverTest {
    ...
    private static final String TEST_PROJECT = "/tmp/auditcli-code-retriever";
    private VectorStore store;

    @BeforeEach
    void setUp() throws Exception {
        System.setProperty("auditcli.rag.dir", "/tmp/auditcli-test-rag-retriever");
