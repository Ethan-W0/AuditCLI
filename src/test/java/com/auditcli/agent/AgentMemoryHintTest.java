...
import com.auditcli.llm.GLMClient;
...
class AgentMemoryHintTest {
    ...
    void explicitChromeRememberRequestStoresSitePreferenceInLongTermMemory() {
        String oldMemoryDir = System.getProperty("auditcli.memory.dir");
        System.setProperty("auditcli.memory.dir", tempDir.toString());
        try {
            ...
            agent.run("打开 https://www.yuque.com/user/doc 这个语雀文档");
            ...
            if (oldMemoryDir == null) {
                System.clearProperty("auditcli.memory.dir");
            } else {
                System.setProperty("auditcli.memory.dir", oldMemoryDir);
            }
        }
    }
