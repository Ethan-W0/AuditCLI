package com.auditcli.mcp.transport;
    ...
    private void startStdoutReader() {
        Thread thread = new Thread(() -> {
            try (BufferedReader reader = new BufferedReader(
                ...
                appendStderr("[auditcli] stdout reader stopped: " + e.getMessage());
            }
        }, "auditcli-mcp-stdio-stdout");
    ...
    private void startStderrReader() {
        Thread thread = new Thread(() -> {
            try (BufferedReader reader = new BufferedReader(
                ...
                appendStderr("[auditcli] stderr reader stopped: " + e.getMessage());
            }
        }, "auditcli-mcp-stdio-stderr");
        thread.setDaemon(true);
        thread.start();
    }
