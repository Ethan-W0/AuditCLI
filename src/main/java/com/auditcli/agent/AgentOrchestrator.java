...
public class AgentOrchestrator {
     ...
     */
    public void setSkillSystem(com.auditcli.skill.SkillRegistry skillRegistry,
                               com.auditcli.skill.SkillContextBuffer skillContextBuffer) {
    ...
    private void runBatchParallel(List<ExecutionStep> batch, List<ExecutionStep> steps,
        ...
        ExecutorService executor = Executors.newFixedThreadPool(parallelism, r -> {
            Thread t = new Thread(r, "auditcli-multi-agent");
            t.setDaemon(true);
            return t;
        });
