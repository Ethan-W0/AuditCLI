...
public class RuntimeThreadStore implements AutoCloseable {
    ...
    public static Path defaultDbPath() {
        String configured = System.getProperty("auditcli.runtime.dir");
        if (configured == null || configured.isBlank()) {
            configured = System.getenv("AUDITCLI_RUNTIME_DIR");
        }
        if (configured == null || configured.isBlank()) {
            configured = Path.of(System.getProperty("user.home"), ".auditcli", "runtime").toString();
        }
