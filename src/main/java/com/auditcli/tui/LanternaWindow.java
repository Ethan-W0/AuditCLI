...
public final class LanternaWindow {
     ...
     */
    public LanternaWindow(AuditCliConfig config, LlmClient llmClient) throws IOException {
        ...
        this.mainWindow = new BasicWindow("AuditCLI v16.0.0");
    ...
    public AuditCliConfig getConfig() {
        return config;
    }
}
