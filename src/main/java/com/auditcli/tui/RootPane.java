...
import com.auditcli.tui.pane.FileTreePane;
import com.auditcli.tui.pane.InputBar;
...
public class RootPane extends Panel {
     ...
     */
    public RootPane(AuditCliConfig config, LlmClient llmClient) {
        super();
    ...
    public boolean handleInput(KeyStroke keyStroke) {
        ...
        if (keyStroke.getKeyType() == KeyType.Character && keyStroke.isCtrlDown() && keyStroke.getCharacter() == 'P') {
            centerPane.appendSystemMessage("对话历史已持续保存到 ~/.auditcli/history/。");
            return true;
        }
