...
import com.auditcli.tui.history.ConversationSnapshot;
import com.auditcli.tui.pane.CenterPane;
import com.auditcli.tui.pane.StatusPane;
...
public final class TuiSessionController implements AutoCloseable {
    ...
    private final AuditCliConfig config;
    ...
    public TuiSessionController(AuditCliConfig config,
                                LlmClient llmClient,
                                Agent reactAgent,
        ...
        this.executor = Executors.newSingleThreadExecutor(r -> {
            Thread thread = new Thread(r, "auditcli-tui-agent-runner");
